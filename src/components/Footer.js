...
export default function Footer() {
  return (
    <>
      <footer className="relative bg-slate-800 pt-8 pb-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              <h4 className="text-3xl text-white font-semibold">Contact</h4>
              <h5 className="text-lg mt-0 mb-2 text-slate-200">
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  <span className="block uppercase text-slate-100 text-sm font-semibold mb-2">
                    Useful Links
                  </span>
